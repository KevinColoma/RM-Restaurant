...
router.get('/api/restaurants', requireAuth, restaurantController.getRestaurant)
...
router.get('/edit-item/:id', requireAuth, async (req, res) => {
    try {
        ...
        const menu = await Menu.findOne({ _id: req.params.id, restaurantId: req.restaurant.restaurantId });
...
router.get('/edit-inventory/:id', requireAuth, async (req, res) => {
    try {
        ...
        const item = await InventoryItem.findOne({ _id: req.params.id, restaurantId: req.restaurant.restaurantId });
...
router.delete('/deleteinventory/:id',requireAuth,inventoryController.deleteInventory );
...
router.put('/customers/:id', requireAuth, customerController.updateCustomer)
...
router.get('/edit-expense/:id', requireAuth, async (req, res) => {
    try {
        const expense = await Expense.findOne({ _id: req.params.id, restaurantId: req.restaurant.restaurantId });
