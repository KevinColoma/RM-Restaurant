...
<input type="number" name="quantity" id="quantity" class="form-control" value="${item.quantity || 0}" required>
</div>
</div>
<div class="col-lg-4 col-sm-6 col-12">
<div class="form-group">
<label>Price</label>
<input type="number" name="price" id="price" step="0.01" class="form-control" value="${item.price || 0}" required>
</div>
</div>
<div class="col-lg-4 col-sm-6 col-12">
<div class="form-group">
